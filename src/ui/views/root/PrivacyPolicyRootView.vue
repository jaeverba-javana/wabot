...
<template>
	...
	<p>El presente Política de Privacidad establece los términos en que Vannia usa y
	...
	<p>Vannia está altamente comprometido para cumplir con el compromiso de mantener
	...
	<p>Una cookie se refiere a un fichero que es enviado con la finalidad de
		...
		web.</p>
	<p>Nuestro sitio web emplea las cookies para poder identificar las páginas que
		...
		usted así lo quiera y la proporcione directamente <a href=""
																												 target="_blank"></a>.
	...
	<p>Este sitio web pudiera contener en laces a otros sitios que pudieran ser de
		...
		tanto no somos responsables de los <a
				href="https://plantillaterminosycondicionestiendaonline.com/"
				target="_blank">términos o privacidad</a> ni de la protección de sus datos
	...
	<p>Esta compañía no venderá, cederá ni distribuirá la información personal que
		es recopilada sin su consentimiento, salvo que sea requerido por un juez con
		un orden judicial.</p>
	<p>Vannia Se reserva el derecho de cambiar los términos de la presente Política
		de Privacidad en cualquier momento.</p>
	<p>Esta politica de privacidad se han generado en <a
			href="https://politicadeprivacidadplantilla.com/" target="_blank">politicadeprivacidadplantilla.com</a>.<br>
	</p>
</template>
